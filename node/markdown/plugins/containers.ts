...
export const containerPlugin = (md: MarkdownIt, options?: ContainerOptions) => {
  md.use(...createContainer("tip", options?.tipLabel || "TIP", md))
    ...
    .use(container, "raw", {
      render: (tokens: Token[], idx: number) =>
        tokens[idx].nesting === 1 ? `<div class="raw">\n` : `</div>\n`,
    })
...
function createContainer(
  ...
  return [
    ...
    klass,
    {
      render(tokens, idx, _options, env: any & { references?: any }) {
